...
// import { registerUser, loginUser, clearMessages } from '../slices/authSlice'; // Removed validateToken
...
//   const { isAuthenticated, loading, error, successMessage, isValidating } = useSelector((state) => state.auth);

//   // Removed validateToken from useEffect
//   useEffect(() => {
...
//     e.preventDefault();
//     console.log('Submitting:', { username: formData.username, password: formData.password });
//     if (view === 'login') {
